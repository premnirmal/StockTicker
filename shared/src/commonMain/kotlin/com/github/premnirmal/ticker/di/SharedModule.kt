 ...
 * clients, the [com.github.premnirmal.ticker.network.CrumbStore] and the application
 * [kotlinx.coroutines.CoroutineScope] — are contributed by the platform module (Android wires
 * them in `:app`; iOS will provide its own equivalents), so this single module is reused by every
 * platform.
 */
