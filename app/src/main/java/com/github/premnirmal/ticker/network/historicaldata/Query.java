...
public class Query implements Parcelable {
  ...
  @SerializedName(FIELD_COUNT) public int mCount;
  @SerializedName(FIELD_RESULTS) public History mResult;
  @SerializedName(FIELD_CREATED) public String mCreated;
  @SerializedName(FIELD_LANG) public String mLang;
