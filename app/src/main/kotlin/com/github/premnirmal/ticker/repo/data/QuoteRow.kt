...
data class QuoteRow(
  ...
  @ColumnInfo(name = "oth_price") val othPrice: Float,
  @ColumnInfo(name = "oth_change_percent") val othChangeInPercent: Float,
  @ColumnInfo(name = "oth_change") val othChange: Float,
